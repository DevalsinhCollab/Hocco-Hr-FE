...
import { updateEmployee } from "../../features/EmployeeDetailSlice";
import { LoadingButton } from "@mui/lab";

const EmployeeEditModal = ({ show, setShow, callApi }) => {
  ...
  const handleSubmit = async () => {
    ...
    const response = await dispatch(updateEmployee(finalData));
