...
import { getAllCfas, updateSignAgreementForCfa } from "../../features/CfaSlice";

const ViewCfaDoc = ({ show, setShow, data, callApi }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (response && response.type == "updateSignAgreementForCfa/fulfilled") {
