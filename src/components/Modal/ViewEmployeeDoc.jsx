...
import { updateSignAgreementForEmployee } from "../../features/DocumentSlice";
import Tooltip from "@mui/material/Tooltip";
import { toast } from "react-toastify";

const ViewEmployeeDoc = ({ show, setShow, data }) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      if (data.document && typeof data.document == "string") {
        ...
        setPdfUrl(data.document.Location);
      }
  ...
  const handleSubmit = async () => {
    ...
    if (
      response &&
      response.type == "updateSignAgreementForEmployee/fulfilled"
    ) {
...
export default ViewEmployeeDoc;
