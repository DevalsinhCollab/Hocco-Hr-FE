...
import { updateSignAgreementForCfa } from "../../features/CfaSlice";
import { updateSignAgreementForVrs } from "../../features/VrsSlice";

const ViewVrsDoc = ({ show, setShow, data, callApi }) => {
  const dispatch = useDispatch();
  const { loading: docLoading } = useSelector((state) => state.cfaData);
  ...
  const handleSubmit = async () => {
    ...
    if (response && response.type == "updateSignAgreementForVrs/fulfilled") {
